		...
		if(entity instanceof PlayerEntity) {
			if (world.isClient()) {
				...
				entity.setNoGravity(true);
					...
					if (!((EntityAttachments) entity).portalcubed$isInFunnel()) {
						((EntityAttachments) entity).portalcubed$setInFunnel(true);
						entity.setVelocity(0, 0, 0);
					}

					((EntityAttachments) entity).portalcubed$setFunnelTimer(2);
