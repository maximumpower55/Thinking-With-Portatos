...
public class MoralityCoreModel extends EntityModel<MoralityCoreEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		bb_main.addChild("cube_r1", ModelPartBuilder.create().uv(15, 26).cuboid(4.0159F, -2.5F, -1.816F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F))
		...
		bb_main.addChild("cube_r2", ModelPartBuilder.create().uv(24, 6).cuboid(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.0F, 3.175F, 0.0F, 3.1416F, 0.0F));
