...
public class HoopyModel extends EntityModel<HoopyEntity> {
	...
	@Override
	public void setAngles(HoopyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
