...
public class FactCoreModel extends EntityModel<FactCoreEntity> {
	public static final EntityModelLayer FACT_CORE_LAYER = new EntityModelLayer(new Identifier(PortalCubed.MODID,"fact_core"), "main");
	...
	@Override
	public void setAngles(FactCoreEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
