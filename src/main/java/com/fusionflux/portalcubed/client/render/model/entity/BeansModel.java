...
public class BeansModel extends EntityModel<BeansEntity> {
	...
	@Override
	public void setAngles(BeansEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
