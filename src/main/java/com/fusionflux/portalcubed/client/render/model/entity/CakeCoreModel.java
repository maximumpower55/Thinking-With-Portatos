...
public class CakeCoreModel extends EntityModel<CakeCoreEntity> {
	public static final EntityModelLayer CAKE_CORE_LAYER = new EntityModelLayer(new Identifier(PortalCubed.MODID,"cake_core"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		bb_main.addChild("cube_r1", ModelPartBuilder.create().uv(19, 26).cuboid(-2.4F, -3.0F, 3.0F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.5F, 5.0F, 3.5F, 0.0F, -0.7854F, 1.5708F));

		bb_main.addChild("cube_r2", ModelPartBuilder.create().uv(19, 26).cuboid(-2.5F, -3.0F, 3.25F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.5F, -3.0F, 3.5F, 0.0F, -0.7854F, 1.5708F));

		bb_main.addChild("cube_r3", ModelPartBuilder.create().uv(24, 9).cuboid(-1.5F, -1.5F, 0.35F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.0F, 3.175F, 0.0F, 3.1416F, 0.0F));
	...
	@Override
	public void setAngles(CakeCoreEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
