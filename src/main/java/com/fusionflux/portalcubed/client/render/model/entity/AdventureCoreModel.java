...
public class AdventureCoreModel extends EntityModel<AdventureCoreEntity> {
	...
	public AdventureCoreModel(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		bb_main.addChild("cube_r4", ModelPartBuilder.create().uv(24, 3).cuboid(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.0F, 3.425F, 0.0F, 3.1416F, 0.0F));
